...
any non printable charactes which may case problems like
the backslash character. In this algoritm we xor each character of the 
...
Vigenere_encrypt: Here we first make the table with the alphabet. To encrypt we match the corresponding column of the 
